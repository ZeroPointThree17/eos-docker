...
(module
 ...
 (data (i32.const 992) "lowest_ask >= exchange_bid.at_price or buyer\'s bid has been filled\n\00")
 (data (i32.const 1072) "saving buyer\'s account\n\00")
 (data (i32.const 1104) " eos left over\00")
 (data (i32.const 1120) "bid filled\n\00")
 (data (i32.const 1136) " created sell for \00")
 (data (i32.const 1168) "\n No bids found, saving seller account and storing ask\n\00")
 (data (i32.const 1232) "\n bids found, lets see what matches\n\00")
 (data (i32.const 1280) "saving ask\n\00")
 (data (i32.const 1296) "ask filled\n\00")
 (data (i32.const 1312) "bid with this id does not exists\00")
 (data (i32.const 1360) "bid removed\n\00")
 (data (i32.const 1376) "ask with this id does not exists\00")
 (data (i32.const 1424) "ask removed\n\00")
 (data (i32.const 1440) "message shorter than expected\00")
 (data (i32.const 1472) "unknown action\00")
 (data (i32.const 1488) "currency\00")
 (data (i32.const 1504) "transfer\00")
 (data (i32.const 1520) "eos\00")
